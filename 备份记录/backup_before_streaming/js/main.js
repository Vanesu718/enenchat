      ...
      <div class="blue-card-top">
        <div class="blue-card-avatar${ringClass}"><img src="${avatar}"></div>
          <div class="blue-card-status">
            <div class="bc-status-item thoughts"><div class="bc-label"><img src="ICON/心声.png" style="width:14px;height:14px;margin-right:2px;vertical-align:middle;"> 心声</div><div class="bc-val">${(statusData?.thoughts || '没有想法').substring(0,15)}</div></div>
            ...
            <div class="bc-status-item favor"><div class="bc-label"><img src="ICON/好感.png" style="width:14px;height:14px;margin-right:2px;vertical-align:middle;"> 好感度</div><div class="bc-val">${statusData?.favor || 0}%</div></div>
          </div>
      </div>
...
严禁使用单一词汇（如“我是个冷酷/温柔的人”）来总结自己，必须用细节去佐证人设！`;
  ...
  systemPrompt += `【人设】${currentSpeaker.persona || '无'}\n${globalRulesPrompt}\n`;
...
function openForumDetail(boardKey, postId) {
  ...
  mainEl.innerHTML = `
    ...
    <div style="display:flex; gap:20px; border-top:1px solid ${board.postBorder}; padding-top:15px;">
      <div style="font-size:13px; color:${board.postTimeColor}; cursor:pointer;"><img src="ICON/点赞.png" style="width:16px;height:16px;vertical-align:middle;margin-right:4px;">点赞 (${post.likes || 0})</div>
      <div style="font-size:13px; color:${board.postTimeColor}; cursor:pointer;"><img src="ICON/评论.png" style="width:16px;height:16px;vertical-align:middle;margin-right:4px;">评论 (${post.comments?.length || 0})</div>
    </div>
  `;
    ...
    div.innerHTML = `
      ...
      <div class="moment-content">${moment.content}</div>
        <div class="moment-actions">
          <div class="moment-action-btn" onclick="likeMoment('${moment.id}')">${(moment.likes && moment.likes.indexOf('我') > -1) ? '<span style="color:var(--main-pink);"><img src="ICON/点赞.png" style="width:16px;height:16px;vertical-align:middle;margin-right:4px;">已赞</span>' : '<img src="ICON/点赞.png" style="width:16px;height:16px;vertical-align:middle;margin-right:4px;">赞'}</div>
          <div class="moment-action-btn" onclick="commentMoment('${moment.id}')"><img src="ICON/评论.png" style="width:16px;height:16px;vertical-align:middle;margin-right:4px;">评论</div>
          <div class="moment-action-btn delete-moment" onclick="deleteMoment('${moment.id}')"><img src="ICON/删 除.png" style="width:16px;height:16px;vertical-align:middle;margin-right:4px;">删除</div>
        </div>
      ${commentsHtml}
    `;
