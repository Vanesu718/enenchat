...
def update_index_html():
    ...
    if 'openSub(\'forum-page\')' not in html:
        html = html.replace(
            '<div class="menu-item" onclick="openSub(\'moments-page\')">朋友?/div>',
    ...
    <div class="sub-page" id="forum-page">
      ...
      <div class="page-body" id="forum-content" style="padding: 10px; background: #f5f5f5; overflow-y: auto;">
        <!-- Posts will be generated here -->
      </div>
    </div>
    """
    
    if 'id="forum-page"' not in html:
        html = html.replace('<!-- Sub Pages -->', '<!-- Sub Pages -->\n' + forum_html)
        if 'id="forum-page"' not in html:
            # Fallback if <!-- Sub Pages --> doesn't exist
            html = html.replace('<div class="sub-page" id="moments-page">', forum_html + '\n    <div class="sub-page" id="moments-page">')
...
"""
    ...
    if 'let currentForumTab' not in html:
