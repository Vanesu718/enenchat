...
# Replace in chat settings
parts = html.split('<!-- 用户人设设定 -->')
if len(parts) >= 3:
    # First occurrence in single chat settings
    parts[0] = parts[0] + chatSettingsInject + '\n        <!-- 用户人设设定 -->'
    # Second occurrence in group chat settings
    parts[1] = parts[1] + groupChatSettingsInject + '\n        <!-- 用户人设设定 -->'
    html = "".join(parts)
else:
